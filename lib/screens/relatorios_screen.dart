  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Text(
            'Dados da última sincronização. Meta, comissão e ranking ficam para uma próxima fase.',
            style: TextStyle(fontSize: 12, color: Color(0xFF64748B), height: 1.35),
          ),
          const SizedBox(height: 14),
          ReportMenuTile(
            title: 'Minhas vendas',
            subtitle: 'Hoje, semana, mês, ticket médio',
          ...
          ReportMenuTile(
            ...
            subtitle: 'Compras, visitas e status',
          ...
          ReportMenuTile(
            ...
            subtitle: 'Histórico de visitas sem venda',
